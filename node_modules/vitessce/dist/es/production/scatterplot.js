...
var external_d3_force_ = __webpack_require__(149);
...
var external_d3_quadtree_ = __webpack_require__(105);
...
return[mappedCell[0],-mappedCell[1],0];};};var makeDefaultGetCellCoords=function makeDefaultGetCellCoords(mapping){return function(cell){return cell.mappings[mapping];};};var Scatterplot_makeDefaultGetCellColors=function makeDefaultGetCellColors(cellColors,theme){return function(cellEntry){var _ref=cellColors&&cellColors.get(cellEntry[0])||Object(utils["n" /* getDefaultColor */])(theme),_ref2=Object(slicedToArray["a" /* default */])(_ref,4),r=_ref2[0],g=_ref2[1],b=_ref2[2],a=_ref2[3];return[r,g,b,255*(a||1)];};};/**
...
this.onUpdateCellsData();this.forceUpdate();}if(['cells','cellFilter','cellSelection','cellColors','cellRadius','cellOpacity','cellRadiusMode','geneExpressionColormap','geneExpressionColormapRange','geneSelection','cellColorEncoding'].some(shallowDiff)){// Cells layer props changed.
...
var Scatterplot = __webpack_require__(120);
...
/* harmony import */ var _ScatterplotSubscriber__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(132);
...
/* harmony import */ var _Scatterplot__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(120);
